...
export default function Profile() {
  ...
  return (
    ...
    >
      ...
      {/* Quote aligned to the right side */}
      <p
        className="text-stone-50 font-sans text-xl sm:text-2xl md:text-3xl leading-relaxed absolute right-6 sm:right-16 lg:right-28 top-24 sm:top-32 lg:top-20 w-full sm:w-1/2 lg:w-1/3 text-right"
      >
        “What are you so hesitant about? It’s your dream, isn’t it? Right there in front of you, and still you waver? Be reckless! Seize everything you can!”
      </p>
    </div>
