    ...
    <div className="flex flex-col justify-center items-center h-screen bg-slate-950">
      <div className="text-center mb-6 p-4">
        ...
        <p className="text-lg text-stone-50">
          Welcome to all the Gen Z out there as this platform is dedicated for you to learn new things so that technology can reach to a greater height and only you people can do it!
        </p>
      </div>
